      ...
      <section className="bg-[#254f1a] min-h-[100vh grid grid-cols-2">
        <div className="flex justify-center flex-col ml-[10vw] gap-3">
          ...
          <div className="input flex gap-2">
            <input value={text} onChange={(e)=> setText(e.target.value)} className="px-2 py-2 focus:outline-green-800 rounded-md bg-white text-black" type="text" placeholder="Enter your handle" />
